...
#         "iou" : 0.45,
    ...
    def __init__(self, model_path=None, classes_path=None, anchors_path=None,**kwargs):
        ...
        self.__dict__.update(kwargs) # and update with user overrides(複寫)
...
def detect_video(yolo, video_path, output_path=""):
    ...
    # cv2.CAP_PROP_FOURCC , 4个字符表示的视频编码器格式
    video_FourCC    = int(vid.get(cv2.CAP_PROP_FOURCC))
    # cv2.CAP_PROP_FPS , 帧速
    video_fps       = vid.get(cv2.CAP_PROP_FPS)
    # cv2.CAP_PROP_FRAME_WIDTH , 寬 ;  cv2.CAP_PROP_FRAME_HEIGHT , 高
